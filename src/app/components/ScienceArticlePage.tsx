...
> = {
  ...
  'Human appetite · Brain & behavior': {
    pageBg: 'from-slate-50 via-indigo-50 to-violet-50',
    pill: 'from-indigo-600 to-violet-600',
    h1: 'from-indigo-800 to-violet-800',
    h2: 'from-indigo-800 to-violet-800',
    heroFrom: 'from-indigo-200',
    heroTo: 'to-violet-200',
    quickBorder: 'border-indigo-400',
    quickLabel: 'text-indigo-950',
    ctaFrom: 'from-indigo-700',
    ctaTo: 'to-violet-600',
    linkClass: 'text-indigo-900',
  },
  'Human appetite · Food chemistry': {
    pageBg: 'from-amber-50 via-orange-50 to-rose-50',
    pill: 'from-amber-600 to-orange-600',
    h1: 'from-amber-900 to-orange-900',
    h2: 'from-amber-900 to-orange-900',
    heroFrom: 'from-amber-200',
    heroTo: 'to-orange-200',
    quickBorder: 'border-amber-400',
    quickLabel: 'text-amber-950',
    ctaFrom: 'from-amber-700',
    ctaTo: 'to-orange-600',
    linkClass: 'text-amber-950',
  },
  'Human appetite · Evolution': {
    pageBg: 'from-stone-50 via-amber-50 to-yellow-50',
    pill: 'from-stone-600 to-amber-700',
    h1: 'from-stone-800 to-amber-900',
    h2: 'from-stone-800 to-amber-900',
    heroFrom: 'from-stone-200',
    heroTo: 'to-amber-200',
    quickBorder: 'border-stone-400',
    quickLabel: 'text-stone-900',
    ctaFrom: 'from-stone-700',
    ctaTo: 'to-amber-700',
    linkClass: 'text-stone-900',
  },
};
