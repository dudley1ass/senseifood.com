...
const SPEC: ScienceArticleSpec = {
  ...
  "intro": "Most sauce failures get worse because cooks apply multiple corrections at once. That hides causality and makes recipes impossible to replicate.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphs": [
        "Define one problem, choose one correction, taste, log, repeat until target state."
      ],
