  ...
  "sections": [
    {
      ...
      "paragraphs": [
        "You want a glaze that flows—not a brittle candy shell. Overheated sugar moves from caramel to acrid quickly, especially in thin layers on hot metal. Keep the pan moving or control burner output; watch color and smell as much as clock time. If you reduce too dry, soy proteins and sugar can scorch in spots. A splash of water buys forgiveness; rebuild sheen with gentle heat."
      ]
    },
    {
      "heading": "Balance: salt, sweet, umami, and late acid",
      "paragraphs": [
        "If it tastes flat, verify salt threshold before chasing sweetness—soy brings both salt and umami, and duplicate soy is not always the answer. If it tastes cloying, a measured acid touch after the salt is plausible can lift without reading sour. Rice vinegar or citrus can work; add in drops and taste. Acid before salt often misleads the tongue in soy-led builds."
      ],
    ...
    },
    {
      ...
      "paragraphs": [
        "Mirin contributes sweetness and aroma; different grades vary in sugar and salt. Taste your bottle before scaling blindly. Briefly boiling off harsh alcohol heat matters when you want clean aroma in a fast glaze. If you substitute honey or brown sugar, expect faster browning—lower heat accordingly."
      ]
    },
    {
      "heading": "Protein glazing technique",
      "paragraphs": [
        "Pat proteins dry so the glaze sticks instead of washing off into the pan. Build layers: glaze, flip, reduce pan sauce, repeat, rather than one flood that never adheres. Cornstarch slurries change behavior—thicker cling, different shine. Match thickness to how you want the sauce to ride on the food."
      ]
    },
    {
      "heading": "Storage and reheating",
      "paragraphs": [
        "Sugar-heavy glazes crystallize or tighten in the fridge. Reheat gently with a splash of water; whisk to restore shine. Microwave in bursts if you must; even heat reduces scorch risk. If the stored glaze tastes flat, refresh with a tiny fresh soy or aromatics at reheat—not more sugar by default."
      ]
    }
  ],
  "faqs": [
