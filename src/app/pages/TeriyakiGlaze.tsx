...
const SPEC: ScienceArticleSpec = {
  ...
  "level": "Recipe guide",
  "emoji": "🍯",
  "quickAnswer": "Sugar caramelizes as water leaves — pull the pan before blackening; bitter is one step past glossy.",
  "intro": "Teriyaki-style glazes combine soy umami, sweeteners, and often mirin’s gentle acid and aroma. The wheel helps separate salt pull from umami depth — they stack, but they are not the same fix.",
  "sections": [
    {
