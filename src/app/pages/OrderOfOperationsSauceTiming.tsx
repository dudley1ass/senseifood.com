  ...
  "sections": [
    {
      ...
      "paragraphs": [
        "Early acid can change how flour and starches hydrate, sometimes thinning unexpectedly or adding a cloudy tang depending on pH. Early wine reductions drive off alcohol and concentrate flavor; late wine can read boozy if not cooked. Aromatics sweat differently if they hit cold oil versus hot oil; browning order changes the bitter-sweet balance of the foundation."
      ]
    },
    {
      "heading": "Finish stage strategy",
      "paragraphs": [
        "Use finishing fat to round edges and carry aroma compounds. Use finishing acid for brightness and contrast. Taste after each step, because each move changes perception of the next—our palates compare, not absolutize. This workflow reduces the correction spiral where each fix creates a new problem: too sharp → too sweet → too salty."
      ],
    ...
    },
    {
      ...
      "paragraphs": [
        "Roux-based sauces tolerate different acid timing than cornstarch-thickened juices. Know your thickener family: pH and heat both matter to clarity and set. If you plan to reduce hard, avoid locking salt early—concentration will move the goalposts."
      ],
      "bullets": [
        {
          "title": "Dairy",
    ...
    },
    {
      ...
      "paragraphs": [
        "Mounting butter means adding cold butter while moving the pan off heat—sequence and temperature together. Dumping fat early without emulsion structure yields oil slicks later. Blender sauces change order rules: shear forces incorporate differently than pan whisking—still respect volatile ingredients that die under prolonged heat."
      ]
    },
    {
      "heading": "Reheating resets the rules",
      "paragraphs": [
        "A sauce balanced at finish may need a whisper of acid or fresh herbs after refrigeration—volatile compounds fled while you slept. Reheat gently; re-emulsify if needed before re-tasting—do not assume yesterday’s salt reads the same hot today."
      ]
    }
  ],
  "faqs": [
