...
const SPEC: ScienceArticleSpec = {
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphs": [
        "Glossy cohesion usually signals stable structure—light should scatter evenly across the surface. Persistent oil pools that reform after stirring suggest broken emulsions or free fat from protein-laden reductions that were pushed too hard. Sheen from butter finish is not the same as an oil slick—finish sheen should integrate when stirred."
      ],
    ...
    },
    {
      ...
      "paragraphs": [
        "Lower heat first—thermal stress is the usual trigger. Add a small amount of warm liquid (water, stock, cream depending on context) and whisk to rebuild interfaces. Sometimes a fresh yolk or mustard (acting as emulsifier) rescues specific families—match tradition. Re-emulsifying is iterative: thin slightly, whisk, re-tighten with heat control rather than one heroic blob of butter."
      ]
    },
    {
      "heading": "When not to emulsion-fix",
      "paragraphs": [
        "If the sauce is simply too salty or too reduced, dilution helps—but label the problem correctly. You are adjusting concentration, not rebuilding droplets. If oil floats because you finished with a fat cap intentionally (some chili oils), that is not a broken emulsion—it is design."
      ]
    },
    {
      "heading": "Hybrid sauces: cheese plus reduction",
      "paragraphs": [
        "Many real-world sauces blend paradigms—tomato cream, peppercorn with brandy reduction then cream. Debug the dominant risk first: emulsion stability when dairy is involved; concentration curve when long reducing. Sequence matters: mount fat off heat after reduction stabilizes volume."
      ]
    }
  ],
  "faqs": [
