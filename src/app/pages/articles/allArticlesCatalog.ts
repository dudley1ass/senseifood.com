...
/** Topic-gap and sauce-library articles (each page is `src/app/pages/<Name>.tsx`; routes in `articleContentRoutes` / `inlineGapArticleRoutes`). */
const SCIENCE_GAP_AND_SAUCE_ARTICLE_ROWS: ArticleCardBase[] = [
{
    ...
    },
    {
      ...
      description:
        "Weak scoring, uneven shaping tension, and early crust set force oven spring through sidewalls instead of the score.",
      category: "Bread Science",
      readTime: "8 min read",
    ...
    },
    {
      ...
      description:
        "Lactose crystallization in concentrated dairy bases creates fine grit—distinct from large icy crystals.",
      category: "Ice Cream Science",
      readTime: "8 min read",
      color: "from-cyan-500 to-sky-600",
      url: "/ice-cream-science/why-ice-cream-gets-sandy",
    },
    {
...
const TOPIC_GAP_ARTICLE_CATALOG_ROWS: ArticleCardBase[] = [
  {
  ...
  },
  {
    ...
    description: 'Moisture migration, sugar crystallization, and starch retrograde change texture after the first day.',
    category: 'Cookie Science',
    readTime: '8 min read',
    color: 'from-amber-500 to-orange-600',
    url: '/cookie-science/why-cookies-lose-freshness-overnight',
  },
  {
    title: 'Why Bread Tastes Bland',
    description: 'Short fermentation, low salt, and weak browning flatten flavor even when crumb structure looks fine.',
    category: 'Bread Science',
    readTime: '8 min read',
    color: 'from-yellow-600 to-amber-600',
    url: '/bread-science/why-bread-tastes-bland',
  },
  {
    title: 'Why Bread Has Huge Holes',
    description: 'Same science as large irregular alveoli—shaping, fermentation, and hydration relative to strength.',
    category: 'Bread Science',
    readTime: '8 min read',
    color: 'from-amber-600 to-orange-600',
    url: '/bread-science/why-bread-has-huge-holes',
  },
  {
    title: 'Why Frosting Melts Off Cakes',
    description: 'Warm crumb, unstable emulsions, and sugar phase behavior slide buttercream and cream cheese frostings.',
    category: 'Cake Science',
    readTime: '8 min read',
    color: 'from-pink-500 to-purple-600',
    url: '/cake-science/why-frosting-melts-off-cakes',
  },
  {
    title: 'Why Cakes Taste Oily',
    description: 'Fat separation, broken emulsions, and weak structure—same fixes as oil-out batter science.',
    category: 'Cake Science',
    readTime: '8 min read',
    color: 'from-purple-500 to-rose-600',
    url: '/cake-science/why-cakes-taste-oily',
  },
  {
    title: 'Why Cakes Shrink After Baking',
    description: 'Steam loss, protein contraction, and pan release mechanics pull edges inward during cooling.',
    category: 'Cake Science',
    readTime: '8 min read',
    color: 'from-rose-500 to-pink-600',
    url: '/cake-science/why-cakes-shrink-after-baking',
  },
  {
    title: 'Why Pie Crust Gets Tough After Cooling',
    description: 'Moisture from filling migrates into layers while gluten tightens and starch retrogrades in the shell.',
    category: 'Pie Science',
    readTime: '8 min read',
    color: 'from-amber-600 to-yellow-700',
    url: '/pie-science/why-pie-crust-gets-tough-after-cooling',
  },
  {
    title: 'Why Fruit Pies Leak Juice',
    description: 'Under-set thickeners, burst cells, and steam pressure push syrup through vents and seams.',
    category: 'Pie Science',
    readTime: '8 min read',
    color: 'from-orange-500 to-amber-600',
    url: '/pie-science/why-fruit-pies-leak-juice',
  },
  {
    title: 'Why Pumpkin Pie Weeps',
    description: 'Custard overcoagulation and syneresis leave droplets on the surface after cooling.',
    category: 'Pie Science',
    readTime: '8 min read',
    color: 'from-yellow-600 to-orange-600',
    url: '/pie-science/why-pumpkin-pie-weeps',
  },
  {
    title: 'Why Homemade Ice Cream Melts Unevenly',
    description: 'Overrun gaps, weak emulsions, and heat-shocked microstructure create puddles while solids stay cold.',
    category: 'Ice Cream Science',
    readTime: '8 min read',
    color: 'from-cyan-500 to-blue-600',
    url: '/ice-cream-science/why-homemade-ice-cream-melts-unevenly',
  },
  {
    title: 'Why Ice Cream Tastes Better After Resting Overnight',
    description: 'Aged bases hydrate proteins and stabilizers; hardened ice cream tempers for smoother flavor release.',
    category: 'Ice Cream Science',
    readTime: '8 min read',
    color: 'from-sky-500 to-cyan-600',
    url: '/ice-cream-science/why-ice-cream-tastes-better-after-resting-overnight',
  },
  {
    title: 'Why Coffee Tastes Muddy',
    description: 'Fines, over-extraction, and filtration issues smear clarity and leave a heavy finish.',
    category: 'Coffee Science',
    readTime: '8 min read',
    color: 'from-stone-700 to-amber-800',
    url: '/coffee-science/why-coffee-tastes-muddy',
  },
  {
    title: 'Why Coffee Water Quality Matters',
    description: 'Minerals and alkalinity shift extraction chemistry—same deep dive as our water chemistry guide.',
    category: 'Coffee Science',
    readTime: '8 min read',
    color: 'from-amber-700 to-yellow-700',
    url: '/coffee-science/why-coffee-water-quality-matters',
  },
  {
    title: 'Why Measuring by Weight Matters',
    description: 'Grams remove cup packing error and make hydration and scaling honest.',
    category: 'Baking Science',
    readTime: '8 min read',
    color: 'from-violet-500 to-fuchsia-600',
    url: '/baking-science/why-measuring-by-weight-matters',
  },
  {
    title: 'Why Oven Calibration Matters',
    description: 'Dial temperature rarely equals cavity heat flux; probes and logs beat assumptions.',
    category: 'Baking Science',
    readTime: '8 min read',
    color: 'from-fuchsia-500 to-purple-600',
    url: '/baking-science/why-oven-calibration-matters',
  },
  {
    title: 'Why Overmixing Changes Texture',
    description: 'Gluten alignment, air cells, and friction heat move texture levers differently for cakes, cookies, and bread.',
    category: 'Baking Science',
    readTime: '8 min read',
    color: 'from-purple-500 to-violet-600',
    url: '/baking-science/why-overmixing-changes-texture',
  },
  {
    title: 'Why Cream Sauces Curdle',
    description: 'Heat shock, acid timing, and protein aggregation break dairy emulsions into grainy curds.',
    category: 'Sauce Science',
    readTime: '8 min read',
    color: 'from-rose-600 to-orange-600',
    url: '/sauce-science/why-cream-sauces-curdle',
  },
  {
    title: 'Why Sauces Taste Better the Next Day',
    description: 'Diffusion, emulsion relaxation, and slow flavor integration continue in the fridge.',
    category: 'Sauce Science',
    readTime: '8 min read',
    color: 'from-orange-600 to-amber-600',
    url: '/sauce-science/why-sauces-taste-better-the-next-day',
  },
  {
    title: 'Why Butter Sauces Separate',
    description: 'Butterfat leaves the emulsion when water phase and temperature move outside stability windows.',
    category: 'Sauce Science',
    readTime: '8 min read',
    color: 'from-amber-600 to-rose-600',
    url: '/sauce-science/why-butter-sauces-separate',
  },
  {
